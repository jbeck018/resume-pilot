...
<svelte:head>
	<title>Sign Up - Resume Pilot</title>
</svelte:head>
...
<div class="flex min-h-screen items-center justify-center p-4">
	<Card class="w-full max-w-md">
		<CardHeader class="text-center">
			...
			<CardDescription>Start finding your dream job with AI</CardDescription>
		</CardHeader>
		<CardContent>
			{#if form?.success}
				<div class="rounded-md bg-green-500/10 p-4 text-center text-sm text-green-600">
					<p class="font-medium">Check your email!</p>
					<p class="mt-1">We sent you a confirmation link to complete your signup.</p>
				</div>
			{:else}
				<form
					method="POST"
